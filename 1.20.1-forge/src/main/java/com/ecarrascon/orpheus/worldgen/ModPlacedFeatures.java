...
public class ModPlacedFeatures {
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        register(context, TEARS_OF_HADES_ORE_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.TEARS_OF_HADES_ORE_SMALL_KEY),
                ModOrePlacement.commonOrePlacement(7,
                        HeightRangePlacement.uniform(VerticalAnchor.absolute(-80), VerticalAnchor.absolute(80))));
        register(context, TEARS_OF_HADES_ORE_PLACED_LARGE_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.TEARS_OF_HADES_ORE_LARGE_KEY),
                ModOrePlacement.rareOrePlacement(9,
                        HeightRangePlacement.uniform(VerticalAnchor.absolute(-80), VerticalAnchor.absolute(80))));
        register(context, TEARS_OF_HADES_ORE_PLACED_BURIED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.TEARS_OF_HADES_ORE_BURIED_KEY),
    ...
    private static ResourceKey<PlacedFeature> registerKey(String name) {
        return ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(Orpheus.MOD_ID, name));
    }
